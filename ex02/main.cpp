...
/*   Updated: 2024/11/04 15:46:55 by gchamore         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	try
	{
		...
		std::cout << std::endl
				  << "-----------------Test Print Form State----------------" << std::endl
				  << std::endl;
		std::cout << Form1 << std::endl;
	...
	try
	{
		std::cout << "-----------------Test too high grade on gradetosign----------------" << std::endl
				  << std::endl;
	...
	{
		std::cout << std::endl
				  << "-----------------Test too high grade on gradetoexecute----------------" << std::endl
				  << std::endl;
	...
	{
		std::cout << std::endl
				  << "-----------------Test too low grade on gradetosign----------------" << std::endl
				  << std::endl;
	...
	{
		std::cout << std::endl
				  << "-----------------Test too low grade on gradetoexecute----------------" << std::endl
				  << std::endl;
	...
	std::cout << std::endl
			  << "-----------------Test Min + Decrement error----------------" << std::endl
			  << std::endl;
	try
	{
	...
	std::cout << std::endl
			  << "-----------------Test max + Increment error----------------" << std::endl
			  << std::endl;
	...
	std::cout << std::endl
			  << "-----------------Test construction error because of Min error----------------" << std::endl
			  << std::endl;

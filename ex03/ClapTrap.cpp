...
{
	std::cout << "ClapTrap constructor named called" << std::endl;
}
...
{
	if (this->_energyPoints > 0 && this->_hitPoints > 0 && this->_hitPoints + amount <= 100)
	{
		this->_hitPoints += amount;
		...
		std::cout << "\033[33mClapTrap " << this->_name << " can't be repaired to have more than 100 hit points.\033[0m" << std::endl;
}
